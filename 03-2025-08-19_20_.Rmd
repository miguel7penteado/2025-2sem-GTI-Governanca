...
**1. Calcular o valor da empresa após o aporte (Post-money Valuation):**

-   **Capital Social da empresa (Valuation) pré-aporte**:
...
-   **Capital Social da empresa (Valuation) (pós-aporte)**:

    \$ ( R\$ 5.000.000) + ( R\$ 1.000.000 ) = **R\$ 6.000.000**

**2. Calcular a participação do investidor (em percentual):**
...
-   **Percentual do investidor**: (R\$ 1.000.000 / R\$ 6.000.000) \* 100% = **16,67%**
...
II. Para encontrar o número total de cotas após o aporte, podemos usar a seguinte fórmula:
    ...
    -   **Total de cotas (pós-aporte)** = (Cotas do fundador / Participação do fundador)

III. Como o investidor terá 16,67%, sua participação será de 100% - 16,67% = 83,33%.

IV. **Total de cotas (pós-aporte)** = 1.000.000 / 0,8333 = **1.200.000 cotas**

**4. Calcular o número de cotas a serem cedidas ao investidor:**

I.  Agora que sabemos o total de cotas e o seu número de cotas (que não muda), podemos calcular quantas cotas o investidor vai receber.

II. **Cotas do investidor** = Total de cotas (pós-aporte) - Cotas do fundador

III. **Cotas do investidor** = 1.200.000 - 1.000.000 = **200.000 cotas**
